...
public class TrafficLightLookout extends Observable implements Lookout {
    ...
    private LookoutResult trafficLightFound() {
//        Mat frame= Imgcodecs
...
//                        .CV_LOAD_IMAGE_COLOR);
        ...
        if (circles.total() > 1) { // TODO dit is waarschijnlijk juist fout.
            ...
            return new LookoutResult(AutonomousStatus.NO_TRAFFIC_LIGHT, this.car.getCamera().makeSnapshotInByteArray());
        }
    }
