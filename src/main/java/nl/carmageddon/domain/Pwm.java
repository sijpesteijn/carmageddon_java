 ...
 */
public class Pwm {
    private static final Logger log = LoggerFactory.getLogger(Pwm.class);
    ...
    public void setPeriod(int period) throws IOException {
        this.period = period;
        echo(this.periodPath, String.valueOf(period));
    }

    public void setPolarity(int polarity) throws IOException {
    ...
    public void setDuty(int duty) throws IOException {
        this.duty = duty;
